// https://github.com/3tawi/RGB-matrix-Panel/blob/master/examples/plasma_16x32/plasma_16x32.ino
...
const float radius1 =130.4, radius2 =184.0, radius3 =326.4, radius4 =358.6,
            centerx1=80.4, centerx2=62.4, centerx3= 150.6, centerx4= 72.4,
