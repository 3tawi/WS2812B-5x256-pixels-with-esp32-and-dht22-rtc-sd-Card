...
function myFunctionsendate() {
  var n = document.getElementById("mydate");
  var strLine = "sendate?bday=" + n.value;
  var request = new XMLHttpRequest();
  request.open("GET", strLine, false);
  request.send(null);
}
...
function GetArduinodata() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
            ...
            h24val    = this.responseXML.getElementsByTagName('analog')[3].childNodes[0].nodeValue;
            spee0     = this.responseXML.getElementsByTagName('analog')[4].childNodes[0].nodeValue;
            spee1     = this.responseXML.getElementsByTagName('analog')[5].childNodes[0].nodeValue;
            spee2     = this.responseXML.getElementsByTagName('analog')[6].childNodes[0].nodeValue;
            spee3     = this.responseXML.getElementsByTagName('analog')[7].childNodes[0].nodeValue;
            amval     = this.responseXML.getElementsByTagName('analog')[8].childNodes[0].nodeValue;
            cival     = this.responseXML.getElementsByTagName('analog')[9].childNodes[0].nodeValue;
    }
    ...
    document.getElementById("Sped3").innerHTML = spee3 + "Sec";
  ...
  xhttp.send();
            setTimeout('GetArduinodata()', 5000);
        }
function GetMesgeDate()  {
  var xhttp = new XMLHttpRequest();
  xhttp.onreadystatechange = function() {
  if (this.readyState == 4 && this.status == 200) {
      MesgeDate = this.responseXML.getElementsByTagName("data")[0].childNodes[0].nodeValue;
  }
     var codeBlock3 = '<embed type="text/html" src="readtext" class="embed-g" width="98%" height="380px">';
     document.getElementById("dat").innerHTML = 'Date : ' + MesgeDate;
     document.getElementById("ID").innerHTML = codeBlock3;
  }
     ...
     <div class="data-input">
       <table>
         <form action="/" method="POST">
            <td style="width:30%">
                <button class="button-blue" style="width:34%"><span id="TZmesg"></span></button>
                <input type="number" value="0" name="locatz" id="mylocatz" min="-12" max="+12" class="button-blue" style="width:20%">
                <button onclick="myFunctionTz()" class="button-blue" style="width:34%">&laquo;Set&raquo;</button>
            </td>
            <td style="width:30%">
                <b class="Date"><span id="datetime"></span></b></td>
         </form>
        <td style='width:24%'>
    <button onclick="document.getElementById('id01').style.display='block'" class="button-blue" style="width:96%">&laquo;Connect to Wi-Fi&raquo;</button>
...
<tr>
     <div class="data-input">
       <table>
         <form action="/" method="POST">
            <td style="width:20%">
                <button onclick="myFunctionSav()" class="button-blue" style="width:96%">&laquo;Save&raquo;</span></button>
            </td>
            <td style="width:40%">
                <input type="date" value="01/01/2023" name="date" id="myddate" class="button-blue" style="width:32%">
                <input type="time" value="00:00:00" name="tmie" id="mytmie" class="button-blue" step="2" style="width:32%">
                <button onclick="myFunctionTma()" class="button-blue" style="width:22%">&laquo;Set&raquo;</button>
            </td>
            <td style="width:22%">
                <button onclick="myFunctionlo()" class="button-blue">&laquo;Set local Time&raquo;</button>
            </td>
            <td style="width:16%">
                <button class="button-blue" style="width:98%" onclick="myFunction24h()">&laquo;<span id="m24h"></span>&raquo;</button></td>
         </form>
       </table>
     </div>
</tr>
    <tr>
     <div class="data-input">
        <table>
         <form action="/" method="POST">
            <td style="width:20%">
                <button class="button-blue" style="width:98%" onclick="myFunctionMA()">&laquo;<span id="ammesg"></span>&raquo;</button>
            </td>
            <td style="width:20%">
                <button class="button-blue" style="width:98%"><span id="cimesg"></span></button></td>
            <td style="width:20%">
...
<tr>
    <table>
        ...
        <div class="data-input">
            ...
            <button style="width:24%" class="button-blue" onclick="myFunctionMg()">&laquo;Send&raquo;</button>
        </div>
         </form>
        </table>
</tr>
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed0" min="-2" max="2" value="1" class="slider" id="mySpeed0">
        <button class="button-blue" onclick="myFunctionS0()" style="width:20%"><b><span>&laquo;Speed&raquo;</span></b></button>
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed1" min="0" max="200" value="33" class="slider" id="mySpeed1">
        <button class="button-blue" onclick="myFunctionS1()" style="width:20%"><b><span>&laquo;Frame&raquo;</span></b></button>
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed2" min="1" max="80" value="45" class="slider" id="mySpeed2">
        <button class="button-blue" onclick="myFunctionS2()" style="width:20%"><b><span>&laquo;Color&raquo;</span></b></button>
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed3" min="4" max="360" value="10" class="slider" id="mySpeed3">
        <button class="button-blue" onclick="myFunctionS3()" style="width:20%"><b><span>&laquo;Timer&raquo;</span></b></button>
...
<tr>
    <table>
        ...
        <form action="/" method="POST">
        <div class="data-input">
        <input type="date" id="mydate" name="bday" class="button-blue" style="width:22%">
        <button onclick="myFunctionsendate()" class="button-blue" style="width:20%">&laquo;Get&raquo;</button>
        <span id="dat" class="button-blue" style="width:22%"></span>
        </div>
        </form>
        <div class="datta-d">
        <span id="ID"></span>
...
<tr>
     <div class="data-input">
       <table>
         <form action="/" method="POST">
            <td style="width:48%">
            <button class="button-blue" style="width:98%">Refresh</button>
            </td>
            <td style="width:48%">
